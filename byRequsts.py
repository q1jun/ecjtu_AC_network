...
def IdAndPasswd():
    ...
    osList = ["win","linux"]
    try:
        with open(".logindata.data", 'r') as f:
            info = [a.rstrip('\n') for a in f]
        if info.__len__() < 4:
            ...
            with open(".logindata.data", 'w') as f:
...
def ACLogin(ip, id, passwd, isp):
    ...
    headers = {"User-Agent": "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3759.4 Safari/537.36", "Referer": f"http://172.16.2.100/a70.htm?wlanuserip={ip}&wlanacip=null&wlanacname=null&vlanid=0&ip={ip}&ssid=null&areaID=null&mac=00-00-00-00-00-00", "Connection": "keep-alive", "Host": "172.16.2.100:801", "Origin": "http://172.16.2.100"}
    ...
    postData = {"DDDDD": f",0,{id}{isp}", "upass": passwd, "R1": "0", "R2": "0", "R3": "0", "R6": "0", "para": "00", "0MKKey": "123456", "buttonClicked": "", "redirect_url": "", "err_flag": "", "username": "", "password": "", "user": "", "cmd": "", "Login": ""}

    cookiesData = {"ISP_select": isp, "areaID": "null", "ip": ip, "md5_login2": f"%2C0%2C{id}{isp}%7C{passwd}", "program": "test", "ssid": "null", "vlan": "0"}
